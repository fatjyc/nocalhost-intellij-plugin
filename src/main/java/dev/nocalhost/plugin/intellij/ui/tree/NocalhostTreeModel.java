...
import dev.nocalhost.plugin.intellij.topic.NocalhostTreeResourcesUpdateNotifier;
...
public class NocalhostTreeModel extends NocalhostTreeModelBase {
    ...
    public NocalhostTreeModel(Project project, Disposable parent) {
        super(new NocalhostTreeNodeComparator());
        this.project = project;
        insertNode(new LoadingNode(), (MutableTreeNode) root);

        this.project.getMessageBus().connect(parent).subscribe(
                NocalhostTreeResourcesUpdateNotifier.NOCALHOST_TREE_RESOURCES_UPDATE_NOTIFIER_TOPIC,
        ...
        ApplicationManager.getApplication().executeOnPooledThread(() -> {
            try {
                ...
                project.getMessageBus().syncPublisher(
                        NocalhostTreeResourcesUpdateNotifier
                                .NOCALHOST_TREE_RESOURCES_UPDATE_NOTIFIER_TOPIC
                ).action(resourceTypeNode, resources);
